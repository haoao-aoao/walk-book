...
public class TencentCOS {
    // 此处填写的存储桶名称
    private static final String bucketName = "neu-1301643398";
    // secretId
    private static final String secretId = "AKID1nKbdWWZjgOqLblPREl24lCaibEcqMvD";
    // secretKey
    private static final String secretKey = "RcXDdmfOr9BwSiiT2ObYFk01mY4PVKvI";
